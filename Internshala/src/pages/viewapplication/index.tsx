...
const index = () => {
  ...
  const filteredapplications = userapplication.filter((application: any) => {
    ...
    return searchmatch && appStatus.toLowerCase() === filter;
  });
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium ${filter === "approved" || filter === "accepted"
                  ...
                  filteredapplications.map((application: any) => (
                    <tr key={application._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                        <Link href={`/detailapplication?id=${application._id}`}>
                          View Details
                        </Link>
                      </td>
                    </tr>
