...
const Navbar = () => {
  ...
  const handlelogin = async () => {
    try {
      ...
      // If Firebase domain is unauthorized for localhost or popup fails
      if (
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <>
                  <button
                    onClick={handlelogin}
                    className="bg-white border border-gray-300 rounded-lg px-4 py-2 flex items-center justify-center space-x-2 hover:bg-gray-50 text-black text-sm"
                  >
